...
The Clinical Observations implementation uses the Bundle resource which is profiled as below:
...
Conformance rules to be applied to the UKCore-Bundle profile to represent a valid instance for the Clinical Observations exchange of information.
