...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
    <strong>Note:</strong> The Australian guidelines include the use of <a href="https://en.wikipedia.org/wiki/Tall_Man_lettering">Tall-Man</a> within medication names, which has been excluded from this guidance.
</div>
