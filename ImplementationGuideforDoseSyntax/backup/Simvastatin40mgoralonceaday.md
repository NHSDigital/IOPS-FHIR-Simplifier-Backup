...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
    <strong>Dose-based</strong> VTM prescription with additional instructions.
</div>
...
<div>
  ...
  <div class="tab-content snippet">
    <div role="tabpanel" class="tab-pane active" id="xml-2">
      {{xml:example-dosage-simple12-vtm}}
    </div>
    <div role="tabpanel" class="tab-pane" id="json-2">
      {{json:example-dosage-simple12-vtm}}
    </div>
    <div role="tabpanel" class="tab-pane" id="table-2">
      {{table:example-dosage-simple12-vtm}}
    </div>
    <div role="tabpanel" class="tab-pane" id="tree-2">
      {{tree:example-dosage-simple12-vtm}}
    </div>
  </div>
</div>
<!--// end of code snippet -->
