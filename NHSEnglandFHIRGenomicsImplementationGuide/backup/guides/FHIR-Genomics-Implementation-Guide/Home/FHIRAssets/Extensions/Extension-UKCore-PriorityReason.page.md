...
<h4><a href='https://simplifier.net/HL7FHIRUKCoreR4/Extension-UKCore-PriorityReason/~issues?level=File' target="_blank">Propose a change to {{variable:issue}} </a></h4>
</div>
