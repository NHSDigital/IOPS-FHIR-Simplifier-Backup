...
|--
| <a href='https://simplifier.net/resolve?target=simplifier&canonical=https://fhir.hl7.org.uk/StructureDefinition/UKCore-PractitionerRole&scope=fhir.r4.ukcore.stu2@2.0.1-pre-release' target="_blank">https://fhir.hl7.org.uk/StructureDefinition/UKCore-PractitionerRole </a> | [UKCore]() | trial-use |
...
<h4 class='additional-Guidance-Submenu'> practitioner </h4>
SHALL be present. Users SHOULD reference practitioners using an appropriate naming system within the NHS defined within the <a href='https://simplifier.net/guide/NHSDigital/Home/FHIRAssets/AllAssets/Profiles/NHSDigital-Practitioner.guide.md?version=current#identifier' target="_blank"> NHS England IG </a>.Display name MAY be included to aid readability and verification of included identifiers.
...
<h4 class='additional-Guidance-Submenu'> organization </h4>
...
<a name="specialty"></a>
<h4 class='additional-Guidance-Submenu'> specialty </h4>
...
<a name="telecom"></a>
<h4 class='additional-Guidance-Submenu'> telecom </h4>
