...
<div markdown="span" class="alert alert-warning" role="alert"><i class="fa fa-information"></i><b> Important:</b> This is a <b>previously</b> published version. For a full list of available versions, see the <a href="https://simplifier.net/guide/NHSDigital-Medicines/Home/Introduction/Directory.guide.md">directory</a> of published versions </div>
         ...
         <!-- NHS Digital Patient Administration --> 
            <div class="nhsd-t-col-xs-12 nhsd-t-col-s-4">
                <article class="nhsd-m-card">
                    <a href="https://simplifier.net/guide/NHSDigital-2.1.50" class="nhsd-a-box-link "
                        aria-label="Read the NHS Digital Base Guidance">
                        <div class="nhsd-a-box nhsd-a-box--bg-light-grey">
                            <div class="nhsd-m-card__content_container">
                                <div class="nhsd-m-card__content-box">
                                    <h1 class="nhsd-t-heading-s">NHS Digital Base (2.1.50)</h1>
...
FHIR is described as a [RESTful](https://www.hl7.org/fhir/http.html) specification based on common industry level use of the term REST. A set of **recommend** RESTful interactions are described in the *SearchParameters* section of the {{pagelink:CapabilityStatement}}
