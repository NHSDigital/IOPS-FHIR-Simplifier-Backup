...
|--
|  {{pagelink:NHSDigital-MedicationDispense-duplicate-3}} | 1 | * | |
...
- {{pagelink:stdispenseevent-partial }} Example from a sequence of notifications.
- {{pagelink:nddispenseevent-partial }} Example from a sequence of notifications.
- {{pagelink:rddispenseevent-completed }} Example from a sequence of notifications.
- {{pagelink:stdispenseevent-partialwithPatientResource}} Example from a sequence of notifications with an included FHIR Patient resource.
</div>
<div id="XML" role="tabpanel" class="tab-pane">
  {{xml:https://fhir.nhs.uk/MessageDefinition/dispense-notification}}
</div>
