...
|Profile|Min|Max|
|--
| {{pagelink:NHSDigital-MedicationRequest.md}}  | 1 | 1 |
...
<table>
<tr><td>
{{pagelink:PrescriptionOrderHomecareUpdate.md}} homecare order cancellation example (based on 
{{pagelink:PrescriptionOrderHomecareRepeatMedication.md}})
</td></tr>
<tr><td>
{{pagelink: PrescriptionOrderOutpatientCancel.md}} outpatient single medication cancel (based on 
{{pagelink:PrescriptionOrderOutpatientMultipleMedications.md}})
</td></tr>
</table>
</div>
