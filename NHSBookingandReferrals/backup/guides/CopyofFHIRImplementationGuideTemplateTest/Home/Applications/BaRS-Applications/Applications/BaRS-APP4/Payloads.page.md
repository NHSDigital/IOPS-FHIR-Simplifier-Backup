...
The below details the specific guidance around the use of key resources required to create a validation response by the validation Responder to the original referral Requester. See [ServiceRequest - Response Validation Interim](https://simplifier.net/nhsbookingandreferrals/bars-messagedefinition-servicerequest-response-validation-interim) message definition for details.
<br>
...
The below details the specific guidance around the use of key resources required to create a validation response by the validation Responder to the original referral Requester. See [ServiceRequest - Response Validation Full](https://simplifier.net/nhsbookingandreferrals/bars-messagedefinition-servicerequest-response-validation-full) message definition for details.
