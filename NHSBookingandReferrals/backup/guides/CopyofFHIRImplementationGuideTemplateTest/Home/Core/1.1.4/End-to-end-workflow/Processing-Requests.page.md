---
topic: core-EndToEndWorkflow-Processing-1.1.4
---
...
Please see the {{pagelink:Core-StandardPattern-1.1.4, text: Standard Patterns}} for generic guidance for processing messages.
