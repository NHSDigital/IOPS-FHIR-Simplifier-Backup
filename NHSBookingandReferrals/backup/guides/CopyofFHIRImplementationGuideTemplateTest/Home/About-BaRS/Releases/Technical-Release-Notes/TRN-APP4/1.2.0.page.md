...
| <div class="imgHandshake">{{render:handshake}}</div> - New Use-Case Category codes   | New  {{pagelink:core-SPUseCaseCategories-1.1.3, text:Use-Cases Category}}  codes added for use in Application 4. |  <mark style="background-color: LightGreen">non-breaking</mark>  |
