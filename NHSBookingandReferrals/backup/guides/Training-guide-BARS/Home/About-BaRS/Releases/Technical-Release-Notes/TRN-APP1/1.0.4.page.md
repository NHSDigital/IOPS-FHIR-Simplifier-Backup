...
|-------------------------------------------|-------------------------------------------------|-------------------------------------------------------------------------|
| New Use-Case Category codes   | New  {{pagelink:core-SPUseCaseCategories-1.0.3, text:Use-Cases Category}}  codes added for use in Application 1. |  <mark style="background-color: Yellow">correction</mark>  |
| Updates to Application 1 Examples   | Updates to all Application 1 Examples to include the latest Use-Case Category codes. |   <mark style="background-color: LightGreen">non-breaking</mark>  |
