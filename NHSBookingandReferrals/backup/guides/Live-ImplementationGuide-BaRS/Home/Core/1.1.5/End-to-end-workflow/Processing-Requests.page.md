---
topic: core-EndToEndWorkflow-Processing-1.1.5
---
...
Please see the {{pagelink:Core-StandardPattern-1.1.5, text: Standard Patterns}} for generic guidance for processing messages.
