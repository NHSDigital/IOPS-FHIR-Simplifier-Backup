...
<li>{{pagelink:ValueSets-and-CodeSystems-draft}}: This is the list of ValueSets and CodeSystems in development for use within the UK Core.</li>
...
<div markdown="span" class="alert alert-warning" role="alert"><h4><i class="fa fa-info-circle"></i> Associated Implementation Guides</h4>
<ul>
...
<div markdown="span" class="alert alert-warning" role="alert"><h4 id="Licence"><i class="fa fa-legal"></i> Licensing and Publisher</h4></br>
<ul>
<li> 
