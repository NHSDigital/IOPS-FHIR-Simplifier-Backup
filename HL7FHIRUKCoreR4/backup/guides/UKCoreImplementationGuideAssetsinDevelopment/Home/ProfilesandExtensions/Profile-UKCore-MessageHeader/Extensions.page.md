...
<div markdown="span" class="alert alert-warning" role="alert"><h4><i class="fa fa-info-circle"></i> Important note regarding the extension <code>messageheader-response-request</code>. 
