...
<div id="Examples" class="tabcontent">
  ...
  {{pagelink:Example-UKCore-Extension-ObservationBodyStructure}}
  <br><br>
</div>
<div id="Feedback" class="tabcontent">
  <h3>Feedback</h3>
Click here to <a href="https://simplifier.net/HL7FHIRUKCoreR4/Extension-UKCore-ObservationBodyStructure/~issues?level=File">Report Issue for Extension-UKCore-ObservationBodyStructure</a>.
</div>
