...
This UK Core profile is a restraint on the International FHIR resource <a href="https://hl7.org/fhir/R4/location.html" target="_blank">Location</a>, and defines the constraints, extensions, and minimal set of data to query and retrieve location information.
...
{{pagelink:ExampleUKCore-Location-SJUH}}
 ...
 {{pagelink:ExampleUKCore-Location-GeneralPracticeNurseClinic}}   <br><br>
</div>
