...
<div id="Examples" class="tabcontent">
  <h3>Examples</h3>
  <b>Colonoscopy</b> - An example to illustrate a DocumentReference regarding a colonoscopy.
  <br>
  {{pagelink:Example-UKCore-DocumentReference-Colonoscopy}}
  <br><br>
</div>
...
- Query for DocumentReference information
- Exchange DocumentReference information within a FHIR document or message.
