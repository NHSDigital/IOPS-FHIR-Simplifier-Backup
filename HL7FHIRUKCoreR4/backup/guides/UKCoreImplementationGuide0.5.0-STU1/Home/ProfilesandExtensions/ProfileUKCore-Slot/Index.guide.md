---
topic: Profile-Slot-a23e6342-f948-4c62-bc9e-330e2a82a20d
---
## StructureDefinition-UKCore-Slot

Defines the UK Core constraints and extensions on the Slot resource for the minimal set of data to query and retrieve slot information.


## Profile Purpose
This profile records a slot of time on a schedule that may be available for booking appointments.
...
<div id="Examples" class="tabcontent">
  <h3>Examples</h3>
{{pagelink:ExampleUKCore-Slot-AvailableWalkInVisit-050}}
