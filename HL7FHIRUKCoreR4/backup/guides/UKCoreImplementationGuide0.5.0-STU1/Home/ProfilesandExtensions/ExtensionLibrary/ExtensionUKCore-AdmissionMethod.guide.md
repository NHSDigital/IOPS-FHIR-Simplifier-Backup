...
### Purpose
This extension extends the Encounter Resource to support the exchange of information representating the method by which a patient was admitted to hospital, which is currently not supported by the FHIR standard.
...
<div id="Examples" class="tabcontent">
  <h3>Examples</h3>
  {{pagelink:ExampleUKCore-Encounter-AdmissionMethod-050}}
</div>
