...
It is recommended that the `performer.actor` element either references a `practioner` or `organization` resource. However the following references are available:
