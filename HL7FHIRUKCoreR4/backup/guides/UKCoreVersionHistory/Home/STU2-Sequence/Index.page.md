...
<td>2.0.0</td>
<td>4.0.1</td>
<td>UK Core Implementation Guide 2.0.0 - STU1 - Pre-release version of the Second HL7 UK Ballot version of UK Core</td>
</tr>
<tr>
...
<li><b>BREAKING CHANGE:</b> ValueSet UKCore-UnifiedTestList has been retired, and replaced by two new valusets, with new NSOMED CT reference sets</li>
<li><b>BREAKING CHANGE:</b> Reset cardinality on UKCore-Practitioner.identifier sub element system and value</li>
<li><b>BREAKING CHANGE:</b> Removed 'issue' from CodeSystem UKCore-ConditionCategory</li>
<li>Reset the following profiles: <code></code> to draft status</li>
<li>Reset the referencing on all profiles to base resources, with an intelligent redirect within the IG to the UK Core profile</li>
...
<li>Altered UKCore-DiagnosticReport-Lab, UKCore-Obsaervation-Lab, UKCore-ServiceRequest-Lab, to not be derived from UKCore-Observation</li>
<li>Altered slices used in UKCore-DiagnosticReport-Lab, UKCore-Obsaervation-Lab, UKCore-ServiceRequest-Lab</li>
</ul>
</tr>
-->
