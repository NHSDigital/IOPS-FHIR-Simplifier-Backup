...
---
## UK Core Implementation Guide 0.4.0 - STU1 (Pre-release) ##
...
<ul>
<li>This Implementation Guide is  0.4.0 of the UK Core
<li>The Scope of this release is only to provide FHIR assets and guidance for following external review. This guide MUST not be implemented and the current release 0.1.0 should be used for that purpose. For the full version history see the  Version History link in this Implementation Guide's footer.
