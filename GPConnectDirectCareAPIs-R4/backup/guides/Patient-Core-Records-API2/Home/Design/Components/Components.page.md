...
### API platform
To utilise the API Management platform which would offer integrations to central services Person Demographics Service (PDS) as well as an authorisation server that would authenticate and authorise the calling application.
