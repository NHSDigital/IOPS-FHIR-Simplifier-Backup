...
<table data-responsive>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="mro-circle required" title="Required"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-times text-danger" title="The extension 'registrationDetails' is not present in FHIR R4 / UK Core"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><span class="mro-circle required" title="Required"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-exclamation text-warning" title="This element is available as 'communication' in FHIR UK Core"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-exclamation text-warning" title="This element is not present in FHIR R4 / UK Core"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-exclamation text-warning" title="This element is available as 'extension(cadavericDonor)' in FHIR UK Core"></i></td>
        </tr>
        ...
        <!-- extension(multipleBirthBoolean) -->
        <tr>
            <td>extension(multipleBirthBoolean)</td>
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-check text-success"></i></td>
        </tr>
