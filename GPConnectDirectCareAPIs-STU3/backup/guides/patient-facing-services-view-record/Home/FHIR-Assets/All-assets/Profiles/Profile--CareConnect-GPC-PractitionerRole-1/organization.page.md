...
A reference to Organization where the roles are available
(https://developer.nhs.uk/apis/gpconnect-1-6-0/development_branch_surgeries.html) for more details.
