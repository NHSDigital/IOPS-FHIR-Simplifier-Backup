...
Refer to:
- [Get the FHIR capability statement (Foundations)](https://developer.nhs.uk/apis/gpconnect-1-2-7/foundations_use_case_get_the_fhir_capability_statement.html) for the capability statement describing the Foundations and Appointment Management capabilities
- [Get the FHIR capability statement (Access Record Structured)](https://developer.nhs.uk/apis/gpconnect-1-2-7/accessrecord_structured_get_the_fhir_capability_statement.html) for the capability statement describing the Access Record Structured capability
...
Refer to {{pagelink:Home/Examples/Book-an-appointment}} for request and response body examples for a create request.
