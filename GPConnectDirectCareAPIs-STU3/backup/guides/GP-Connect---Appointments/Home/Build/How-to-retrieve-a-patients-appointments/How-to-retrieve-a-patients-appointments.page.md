...
<b>Important:</b> The Appointment Management capability pack is aimed at administration of a patient's appointments. As part of information governance (IG) requirements the retrieval of a patient's appointments has been restricted to future appointments only. Additional details are available on the [Design decisions](https://simplifier.net/guide/pfs-appointments/home-design-design-principals?version=current) page </div>
...
{{render:RetrievePatientsApp.png}}
...
- SHALL return zero or more matching [GPConnect-Appointment-1](https://simplifier.net/guide/PFS-Appointments/Home/FHIR-Assets/All-Assets/Profiles/Profile--GPConnect-Appointment-1?version=current) resources in a `Bundle` of `type` searchset
