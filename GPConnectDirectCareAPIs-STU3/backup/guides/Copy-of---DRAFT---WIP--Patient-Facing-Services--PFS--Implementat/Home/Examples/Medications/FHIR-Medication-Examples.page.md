...
### Access Record Structured FHIR examples for Medication.
...
#### Request payload
The Request payload MUST be a `Parameters` FHIR resource.
...
#### Response payload
The Response payload is a populated `Bundle` resource.
