...
| The patient's NHS number in the provider system is not associated with a NHS number status indicator code of 'Number present and verified' | [`PATIENT_NOT_FOUND`](https://developer.nhs.uk/apis/gpconnect-1-5-1/development_fhir_error_handling_guidance.html#identity-validation-errors) |
