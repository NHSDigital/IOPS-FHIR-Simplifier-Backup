...
<table data-responsive>
    ...
    <tbody>
        ...
        <tr>
            <td>extension(clinicalSetting)</td>
            <td><span class="mro-circle required" title="Required"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-exclamation text-warning" title="This element has been renamed to 'careSettingType' in FHIR UK Core"></i></td>
        </tr>
        <!-- extension(warningCode) -->
        <tr>
            <td>extension(warningCode)</td>
            <td><span class="mro-circle required" title="Required"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td><i class="fas fa-exclamation text-warning" title="This element has been renamed to 'listWarningCode' in FHIR UK Core"></i></td>
        </tr>
