...
*If it is possible on the provider system to record allergy concepts as non-allergies in the patient record, then the system <strong>MUST</strong> express these record entries as FHIR AllergyIntolerance resources when queried.*
