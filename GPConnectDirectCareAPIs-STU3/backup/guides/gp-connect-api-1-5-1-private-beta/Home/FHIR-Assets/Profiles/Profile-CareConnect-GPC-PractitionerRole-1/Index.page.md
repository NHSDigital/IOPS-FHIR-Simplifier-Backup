...
{{tree:https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-GPC-PractitionerRole-1}}
    </div>
    <div role="tabpanel" class="tab-pane" id="dictionary-1">
{{dict:https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-GPC-PractitionerRole-1}}
    </div>
  </div>
</div>