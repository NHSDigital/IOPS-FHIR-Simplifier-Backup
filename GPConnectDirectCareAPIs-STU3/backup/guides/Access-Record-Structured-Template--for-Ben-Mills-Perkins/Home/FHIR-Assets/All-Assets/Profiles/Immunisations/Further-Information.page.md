...
<p>This Boolean element is assumed to be a primary source record unless stated otherwise. However, this can be deemed as unreliable. For example, there may be instances where ‘primarySource’ is unknown, whilst a true or false output will still need to be captured.</p>
