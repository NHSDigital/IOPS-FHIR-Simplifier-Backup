...
Every GP Connect system also has one or more "MHS" records (or message handling server record), identified by Party Key and {{pagelink:Home/Authentication/Integrate-with-Spine/System-topologies.page.md}}.

MHS records of GP Connect provider systems contain the endpoint of a capability at the target practice, as defined by the FHIR service root URL ({{pagelink:Home/Build/General-API-guidance.page.md}}).

Please see {{pagelink:Home/Authentication/Integrate-with-Spine/System-topologies.page.md}} for more details on the allocation of ASIDs and Party Keys.

<div class="nhsd-a-box nhsd-a-box--bg-light-yellow nhsd-!t-margin-bottom-6 nhsd-t-body">
<b>Important</b>: <b>Distinguishing GP Connect provider and consumer SDS records</b><br/>
Providers have GP Connect {{pagelink:Home/Authentication/Integrate-with-Spine/Interaction-IDs.page.md}} on their MHS records; consumers do not. This distinction enables the SDS queries below to return the correct record, where a provider organisation has seperate consumer systems in addition to their main provider system.
</div>
...
GP Connect consumer systems are expected to resolve the FHIR service root URL ({{pagelink:Home/Build/General-API-guidance.page.md}}) and ASID for a given capability at a GP provider organisation using [Spine Directory Service (SDS)](http://digital.nhs.uk/spine) LDAP directory lookups.
...
<div class="nhsd-a-box nhsd-a-box--bg-light-yellow nhsd-!t-margin-bottom-6 nhsd-t-body">
<b>Important</b>: Please note the FHIR service root URL (endpoint) returned for one capability may be different from that for another capability, <b>for the same provider practice</b>.  Please ensure you <b>DO NOT</b> re-use FHIR service root URLs (endpoints) between capabilities.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
<b>Note</b>: <b>Why have SDS queries changed in GP Connect API 1.2.3?</b><br/>
...
- Message Handling System type
	- `objectClass` = `nhsMHS`
- MHS Interaction ID
	- `nhsMhsSvcIA` = *Interaction ID*, please see GP Connect {{pagelink:Home/Authentication/Integrate-with-Spine/Interaction-IDs.page.md}}
...
The consuming system is responsible for performing a PDS trace ({{pagelink:Home/Authentication/Integrate-with-Spine/Personal-Demographic-Service.page.md}}) to both verify the identity of the patient and retrieve the ODS code of the patient's registered primary care practice.
...
<div class="nhsd-a-box nhsd-a-box--bg-light-yellow nhsd-!t-margin-bottom-6 nhsd-t-body">
<b>Important</b>: Please note the FHIR service root URL (endpoint) returned for one capability may be different from that for another capability, <b>for the same practice</b>. Please ensure you <b>DO NOT</b> re-use FHIR service root URLs (endpoints) between capabilities.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-yellow nhsd-!t-margin-bottom-6 nhsd-t-body">
<b>Important</b>: This LDAP query is for a consumer system to lookup their *own* ASID. To determine the provider's ASID and endpoint, please see the queries above.
</div>
...
- Accredited System type
	- `objectClass` = `nhsAs`
- AS Interaction ID
	- `nhsAsSvcIA` = *Interaction ID*, please see GP Connect {{pagelink:Home/Authentication/Integrate-with-Spine/Interaction-IDs.page.md}}
