...
A capability is an area of focus for the GP Connect APIs. There are several {{pagelink:Home/Introduction/Introduction/Capabilities.page.md, text:initial capabilities defined}}.
...
- Read about the GP Connect {{pagelink:Home/Introduction/Introduction/Capabilities.page.md, text:Priority capabilities}}.
