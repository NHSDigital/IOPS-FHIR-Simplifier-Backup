...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
    <b>Note</b>: The organisation resource must be populated with the <b>SENDER</b> details.
</div>
...
<table data-responsive>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td title="Renamed to `organizationPeriod` in UK Core"><i class="fas fa-exclamation text-warning"></i></td>
        </tr>
        <!-- identifier -->
        <tr>
            <td>identifier</td>
