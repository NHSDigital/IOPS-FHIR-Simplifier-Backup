...
<table data-responsive>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td title="Renamed in UK Core to 'patientReligion'"><i class="fas fa-exclamation text-warning"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td title="Renamed in UK Core to 'cadavericDonor'"><i class="fas fa-exclamation text-warning"></i></td>
        </tr>
        ...
        <tr>
            ...
            <td><span class="mro-circle optional" title="Optional"></span></td>
            <td><i class="fas fa-check text-success"></i></td>
            <td title="Renamed in UK Core to 'contactPreference'"><i class="fas fa-exclamation text-warning"></i></td>
        </tr>
