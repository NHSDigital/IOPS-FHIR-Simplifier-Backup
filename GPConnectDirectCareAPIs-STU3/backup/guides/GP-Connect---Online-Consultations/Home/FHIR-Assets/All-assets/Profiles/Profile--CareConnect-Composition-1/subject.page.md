...
The `subject` **MUST** contain a `Patient` resource profiled to the `CareConnect-GPC-Patient-1` [structure definition](https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-GPC-Patient-1).
