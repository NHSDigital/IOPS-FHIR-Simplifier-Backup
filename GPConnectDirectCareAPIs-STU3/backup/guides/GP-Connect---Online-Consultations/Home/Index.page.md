...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-t-body nhsd-!t-margin-bottom-4">
        <b>Note</b>: This is an invite-only private alpha.</div>

Welcome to the Digital First - Online Consultations Implementation Guide.

Use the dropdown menus at the top of the screen to navigate around the site.

If you're brand new here, we recommended you read the {{pagelink:Home/Introduction/Introduction/Introduction.page.md , hint:Introduction}}.
    ...
    <div class="nhsd-t-grid">
        <div class="nhsd-t-row">
            <div class="nhsd-t-col">
                <h2 class="nhsd-t-heading-xl nhsd-t-text-align-center nhsd-!t-margin-bottom-7">Related specifications</h2>
            </div>
        </div>
