...
<div class="example">
  ...
  <button class="nhsd-a-button nhsd-a-button--outline" onclick="window.open('https://simplifier.net/gpconnect2/pharmacy-first-service--example-1/$download?format=xml')">Download</button>
  <button class="nhsd-a-button nhsd-a-button--outline" onclick="window.open('https://simplifier.net/gpconnect2/pharmacy-first-service--example-1/$validate')">Validate</button>

  <div id="XML View" class="tabcontent" style="display:block"> 
    <h3>XML</h3>
    {{xml:pharmacy-first-service--example-1}}
  </div>

  <div id="Table View" class="tabcontent">
    <h3>Table</h3>
    {{table:pharmacy-first-service--example-1}}
  </div>
</div>