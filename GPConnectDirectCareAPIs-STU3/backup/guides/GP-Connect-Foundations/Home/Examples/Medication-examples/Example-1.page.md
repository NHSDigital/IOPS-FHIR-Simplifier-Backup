...
```json
{
  ...
  "entry": [
    ...
    },
    {
      "resource": {
        ...
        "entry": [
          ...
          {
            "item": {
              "reference": "MedicationStatement/985eba1d-e4fd-41ad-90aa-f840dff453d9"
            }
          },
          {
            "item": {
    ...
    },
    {
      "resource": {
        "resourceType": "MedicationStatement",
        "id": "985eba1d-e4fd-41ad-90aa-f840dff453d9",
        "meta": {
          "profile": [
            "https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-GPC-MedicationStatement-1"
          ]
        ...
        "basedOn": [
          {
            "reference": "MedicationRequest/686f3293-b166-4ea8-9951-df262c49a43a"
          }
        ],
        "status": "completed",
        "medicationReference": {
          "reference": "Medication/7e1995cd-a91c-4b49-8fcb-339c479a0c83"
        },
        "effectiveDateTime": "2016-05-10",
        "dateAsserted": "2016-05-10",
        "subject": {
    ...
    },
    {
      "resource": {
        "resourceType": "MedicationRequest",
        "id": "686f3293-b166-4ea8-9951-df262c49a43a",
        "meta": {
          "profile": [
            "https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-GPC-MedicationRequest-1"
          ]
        ...
        "dispenseRequest": {
          ...
          "quantity": {
            "extension": [
              {
                "url": "https://fhir.nhs.uk/STU3/StructureDefinition/Extension-CareConnect-GPC-MedicationQuantityText-1",
                "valueString": "quantity varies dependent on schedule"
              }
            ]
          },
          "validityPeriod": {
    ...
    },
    {
      "resource": {
        ...
        "id": "7e1995cd-a91c-4b49-8fcb-339c479a0c83",
        "code": {
          "coding": [
            {
              "extension": [
