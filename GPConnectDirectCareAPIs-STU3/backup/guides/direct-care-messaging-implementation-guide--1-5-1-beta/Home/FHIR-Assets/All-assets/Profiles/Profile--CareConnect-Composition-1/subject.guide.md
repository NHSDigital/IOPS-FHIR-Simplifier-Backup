...
The `subject` **MUST** contain a `Patient` resource profiled to the `CareConnect-Patient-1` [structure definition](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Patient-1).
