...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Emergency-Codes}} section.
</div>
...
**Information associated with the current emergency can be found on GitHub at [nhsconnect/gpconnect-emergency-codes](https://github.com/nhsconnect/gpconnect-emergency-codes)**
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Encounters}} section.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Problems-and-issues/Active-problems-and-issues.page.md}} section.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Problems-and-issues/Major-inactive-problems-and-issues.page.md}} section.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Allergies-and-adverse-reactions/Current-allergies-and-adverse-reactions.page.md}} section.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Medications/Acute-medication-Last-12-months.page.md}} section.
</div>
...
<div class="nhsd-a-box nhsd-a-box--bg-light-blue nhsd-!t-margin-bottom-6 nhsd-t-body">
        <i class="fas fa-exclamation-circle text-primary"></i> <b>Note:</b> Please see HTML guidance in the {{pagelink:Home/Build/Medications/Current-repeat-medication.page.md}} section.
</div>
