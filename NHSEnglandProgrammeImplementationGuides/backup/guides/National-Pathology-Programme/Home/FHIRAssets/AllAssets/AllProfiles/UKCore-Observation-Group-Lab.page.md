...
### Summary
A set of related tests that are reported together, for example a Full Blood Count. Test groups are more widely referred to as batteries, panels or profiles. 
...
Test results are represented using the {{pagelink:R4ObservationTestResult}} profile.
