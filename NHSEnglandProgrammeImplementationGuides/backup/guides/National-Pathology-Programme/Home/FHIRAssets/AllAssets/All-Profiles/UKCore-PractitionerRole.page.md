...
<div id="Examples" class="tabcontent">
    ...
    <a href="https://simplifier.net/guide/uk-core-implementation-guide-stu2/home/examples/examplesindex/Example-UKCore-PractitionerRole-GP?current">	UKCore-PractitionerRole-GeneralPractitioner-Example</a><br>
</div>

### Additional Guidance
No additional guidance is currently provided for this profile within this implementation guide. Please refer to the Profile Specific Implementation Guidance for `UKCore-PractitionerRole` in the [UK Core Implementation Guide](https://simplifier.net/guide/uk-core-implementation-guide-stu2/home/profilesandextensions/profile-ukcore-practitionerrole?current).
