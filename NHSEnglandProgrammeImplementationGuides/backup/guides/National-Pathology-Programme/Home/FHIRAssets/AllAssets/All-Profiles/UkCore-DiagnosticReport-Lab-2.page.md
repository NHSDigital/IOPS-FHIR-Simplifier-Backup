---
topic: R4DiagnosticReport2
---
## Profile: UKCore-DiagnosticReport-Lab-2
...
### `basedOn`
Reference to the `ServiceRequest` that contains details of the test request that was made. Where present this may include details of who requested the tests and why the test was requested.
...
### `category`
The general type of test report. This **SHALL** be populated with a fixed value of category code `LAB` for `Laboratory`. If required, additional category codes **MAY** also be included.

### `code`
This **SHALL** be populated with a fixed value of SNOMED CT ConceptID `721981007` for `Diagnostic studies report`. The clinical code and name of a test result or a test group is defined in the `code` element of the relevant `Observation` resource.
...
<table class="regular">
    <thead>
        <tr>
            ...
            <th width="85%">Definition, Constraints and Notes</th>
        </tr>
    </thead>
    <tbody>
        <tr>
