...
<div id="Examples" class="tabcontent">
    <h4>Examples</h4>
    <b>Observation (Test Group) Snippets</b> - An example to illustrate how each supported data element may be populated.<br>{{pagelink:R4SnippetsObservationTestGroup}}<br><br>
