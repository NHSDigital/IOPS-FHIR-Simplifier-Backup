...
<div id="Examples" class="tabcontent">
    <h4>Examples</h4>
    <b>UKCore-Specimen Snippets</b> - An example to illustrate how each key data element in <code>UKCore-Specimen</code> may be populated.<br>{{pagelink:R4SnippetsSpecimen}}<br><br>
