...
<div>
  ...
  <div class="tab-content snippet">
    <div role="tabpanel" class="tab-pane active" id="xml-2">
      {{xml:example-bundle-med-dispense-inpatient-resupply-anne-teak}}
    </div>
    <div role="tabpanel" class="tab-pane" id="json-2">
      {{json:example-bundle-med-dispense-inpatient-resupply-anne-teak}}
    </div>
    <div role="tabpanel" class="tab-pane" id="table-2">
      {{table:example-bundle-med-dispense-inpatient-resupply-anne-teak}}
    </div>
    <div role="tabpanel" class="tab-pane" id="tree-2">
      {{tree:example-bundle-med-dispense-inpatient-resupply-anne-teak}}
    </div>
  </div>
</div>
<!--// end of code snippet -->
