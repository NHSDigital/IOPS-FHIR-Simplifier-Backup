...
<div>
  ...
  <div class="tab-content snippet">
    <div role="tabpanel" class="tab-pane active" id="xml-1">
      {{xml:example-bundle-med-statement-self-declared-justin-thyme}}
    </div>
    <div role="tabpanel" class="tab-pane" id="json-1">
      {{json:example-bundle-med-statement-self-declared-justin-thyme}}
    </div>
    <div role="tabpanel" class="tab-pane" id="table-1">
      {{table:example-bundle-med-statement-self-declared-justin-thyme}}
    </div>
    <div role="tabpanel" class="tab-pane" id="tree-1">
      {{tree:example-bundle-med-statement-self-declared-justin-thyme}}
    </div>
  </div>
</div>
<!--// end of code snippet -->