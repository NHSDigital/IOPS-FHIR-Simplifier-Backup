...
<div>
  ...
  <div class="tab-content snippet">
    <div role="tabpanel" class="tab-pane active" id="xml-5">
      {{xml:example-bundle-med-dispense-on-leave-toby-lerone}}
    </div>
    <div role="tabpanel" class="tab-pane" id="json-5">
      {{json:example-bundle-med-dispense-on-leave-toby-lerone}}
    </div>
    <div role="tabpanel" class="tab-pane" id="table-5">
      {{table:example-bundle-med-dispense-on-leave-toby-lerone}}
    </div>
    <div role="tabpanel" class="tab-pane" id="tree-5">
      {{tree:example-bundle-med-dispense-on-leave-toby-lerone}}
    </div>
  </div>
</div>
<!--// end of code snippet -->
